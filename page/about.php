<div style="padding: 0 12px 0 6px;">
    <div class=" form-group">
        ...
        <div class="help-panel-body">
            ...
            In short: No one from Barunson Games, Aeria Games, Gamigo, Bilagames,
            associated with Barunson Games, Aeria Games, Gamigo, Bilagames
            or any such affiliated company or anyone directed by Barunson Games, Aeria Games, Gamigo, Bilagames or its Related companies is permitted to enter these web sites or view any content contained within these sites at any time what so ever due to controversial reasons.
            <br /><br /><br /><br />

            <b>NOTICE OF LEGALITY</b><br /><br />
            ...
            <b>NOTICE OF PERSONAL USAGE</b><br /><br />
            ...
            <b>NOTICE OF DONATING</b><br /><br />
            By donating for <?php echo $GLOBALS['server_name']; ?> you agree to the rules, conditions and terms of service stated above and below.
            ...
            <b>NOTICE OF PROPERTY</b><br /><br />
            Please note that any account made for the use of <?php echo $GLOBALS['server_name']; ?> for any of its services, including but not limited to forum accounts, and game accounts, are property of <?php echo $GLOBALS['server_name']; ?> and thus may be terminated and any time with or without reason.
            By using an account, you are borrowing the service from us and we hold the right to reclaim it at any time we wish.
            Please also note that by donating you are NOT buying your account from us, merely showing your appreciation for our service, and as such you are still subject to rules and regulations set forth by the staff of <?php echo $GLOBALS['server_name']; ?>.
            <br /><br /><br /><br />
            
            <b>ACCOUNT SECURITY</b><br /><br />
            When borrowing an account from <?php echo $GLOBALS['server_name']; ?>, you hereby agree that its security and safety is YOUR responsibility, and thus you will be held accountable for any actions which are done to or from your account.
            You also agree that you are aware that giving out your password may compromise the security of your account, and that upon telling another person your password, you fully accept any consequences which may come of such.
            You agree to acknowledge that if you receive a file from anywhere except an official <?php echo $GLOBALS['server_name']; ?> distributor, it may contain a malicious software known as a "Key logger", and that <?php echo $GLOBALS['server_name']; ?> will not be held responsible for the consequences which may come from downloading these programs from outside sources.
            <br />
            
            We are also not affiliated with any of the already named organizations/companies or to put it straight any association, organization or company that is related to any of the content hosted here at <?php echo $GLOBALS['server_name']; ?>. This is strictly a fan based development association.
            <br /><br />
